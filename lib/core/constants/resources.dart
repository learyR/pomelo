...
class AppImages {
  ...
  static const String iconCategorySearch =
      '${_basePath}icon_category_search.png';
  ...
  static const String iconAddressDivideLine =
      '${_basePath}address_divid_line.png';
  ...
  /// 提现相关
  static const String imageWithdrawSuccess =
      '${_basePath}image_withdraw_success.png';
  static const String imageWithdrawFail = '${_basePath}image_withdraw_fail.png';
  static const String imageWithdrawBind =
      '${_basePath}image_widthdraw_bind.png';

  /// 拼团相关
  static const String imageJoinGroupSuccess =
      '${_basePath}image_join_group_success.png';
  static const String imageJoinGroupFail =
      '${_basePath}image_join_group_fail.png';

  /// 优惠券
  static const String imageCouponOpen = '${_basePath}image_coupon_open.png';
  static const String imageCouponClose =
      '${_basePath}image_new_user_coupon.png';
